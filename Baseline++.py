...
def run_method_comparison_experiment(embedding_file: str = None):
    ...
    print("="*70)
    print(f"🧠 Base classifier: {CLASSIFIER_NAME} (learned weights)")
...
if __name__ == "__main__":
    if IN_COLAB:
        ...
        parser = argparse.ArgumentParser(description="Run the final conformal prediction experiment (Cosine classifier)")
